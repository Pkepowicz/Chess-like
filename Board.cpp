...
Position* Board::getRookMoves(int& positionsCounter, char figure = 'W') {
    ...
    /*
    * pêtla ma wykonywaæ siê, dopóki w kierunku 'góry planszy' pozycja jest wolna
    * oraz nie wykracza poza dostêpny obszar.
    * Aktualna pozycja wie¿y jest baz¹ do tworzenia testowych pozycji, dziêki czemu wiadomo,
    * ¿e jeœli na swojej potencjalnej drodze jakieœ pole jest zajête, ruch na pola nastêpne równie¿
    * jest niemo¿liwy.
    * Jeœli testowa pozycja spe³nia wszystkie warunki, jest dodawana na kolejne miejsce w tablicy.
    *
    * Pozosta³e 3 pêtle dzia³aj¹ w analogiczny sposób, odpowiednio sprawdzaj¹c pola:
    * w dó³
    * w lewo
    * w prawo
    */
